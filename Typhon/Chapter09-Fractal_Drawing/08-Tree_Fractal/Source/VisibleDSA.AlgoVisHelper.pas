...
type
  ...
  public
    ...
    // 绘制三角形
    class procedure DrawTriangle(canvas: TBGRACanvas2D; a, b, c: TPointF);
    // 填充三角形
    class procedure FillTriangle(canvas: TBGRACanvas2D; a, b, c: TPoint);

    // 绘制直线
    class procedure DrawLine(canvas: TBGRACanvas2D; a, b: TPointF);
  end;
...
class procedure TAlgoVisHelper.DrawLine(canvas: TBGRACanvas2D; a, b: TPointF);
begin
  canvas.lineStyle(_strokeStyle);
  canvas.strokeStyle(_strokeColor);
  canvas.lineWidth := _strokeWidth;
...
class procedure TAlgoVisHelper.DrawTriangle(canvas: TBGRACanvas2D; a, b, c: TPointF);
begin
  canvas.lineStyle(_strokeStyle);
  canvas.strokeStyle(_strokeColor);
  canvas.lineWidth := _strokeWidth;
